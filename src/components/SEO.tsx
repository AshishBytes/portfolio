...
const SEO: React.FC<SEOProps> = ({ title, description, image, url, type }) => {
  ...
  return (
    <Helmet>
      ...
      <meta
        name="keywords"
        content="Ashish Singh, Software Engineer, Full Stack Developer, React, Python, Java, Distributed Systems, Backend Development, B.Tech CSE, Amazon, Machine Learning, NLP"
      />
      ...
      <meta
        ...
        content="Ashish Singh - Full Stack Developer"
      />
