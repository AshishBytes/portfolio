  ...
  const certifications = [
    {
      ...
      description:
        'Comprehensive understanding of Azure cloud services, pricing, and support models.',
      color: 'blue',
    },
    {
      ...
      description:
        'Recognition for leadership in cloud computing and community contributions.',
      color: 'green',
    },
    {
      ...
      description:
        "Top performer in Google's competitive programming challenge.",
      color: 'yellow',
    },
    {
      ...
      description:
        'Expertise in designing distributed systems on AWS platform.',
      color: 'orange',
    },
  ];
